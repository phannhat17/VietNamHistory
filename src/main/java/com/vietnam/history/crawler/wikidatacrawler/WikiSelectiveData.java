...
import com.vietnam.history.crawler.myinterface.WikiSelectiveCrawler;
...
public class WikiSelectiveData extends WikiBruteForceData implements WikiSelectiveCrawler {
    ...
    private final HashSet<String> festivalHashSet = new HashSet<>();
    private final HashSet<String> locationHashSet = new HashSet<>();
    private final HashSet<String> humanHashSet = new HashSet<>();
    private final HashSet<String> eventHashSet = new HashSet<>();
    ...
    public static void main(String[] args) throws Exception {
        WikiSelectiveData wikiSelectiveData = new WikiSelectiveData("saveddata/Wikipedia/");
