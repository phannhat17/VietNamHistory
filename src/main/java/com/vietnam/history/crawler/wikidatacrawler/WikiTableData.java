...
import com.vietnam.history.crawler.myinterface.WikiTableCrawler;
...
public class WikiTableData extends WikiBruteForceData implements WikiTableCrawler {
    ...
    private static final String[] kingProp = {"Miếu hiệu", "Tôn hiệu hoặc Thụy hiệu", "Tôn hiệu", "Niên hiệu", "Thế thứ", "Trị vì"};
    ...
    public static void main(String[] args) throws Exception {
        WikiTableData wikiTableData = new WikiTableData("saveddata/Wikipedia/");
